...
import v1.models.errors.{MtdError, UnexpectedFailure, VrnFormatError, VrnNotFound}

import scala.concurrent.ExecutionContext.Implicits.global
import scala.concurrent.Future

class PenaltiesControllerSpec extends ControllerBaseSpec with MockEnrolmentsAuthService
  with MockPenaltiesService with MockPenaltiesRequestParser with MockAuditService with MockIdGenerator {
