...
trait ObligationsFixture {
  ...
  def openObligationDesJson(periodKey: String, from: String, to: String, due: String): JsValue = Json.parse(
    s"""
       |{
       |   "obligations":[
       |      {
  ...
  def assistObligationMtdJson(periodKey: String, start: String, end: String, due: String): JsValue = Json.parse(
    s"""
       |{
       |  "periodKey": "$periodKey",
       |  "start": "$start",
