...
object FromDateFormatError extends MtdError("INVALID_DATE_FROM", "Invalid date from")

object ToDateFormatError extends MtdError("INVALID_DATE_TO", "Invalid date to")

object StatusFormatError extends MtdError("INVALID_STATUS", "Invalid status")
