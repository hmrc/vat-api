...
import uk.gov.hmrc.vatapi.models.ErrorClientNotSubscribedToMTDVAT
...
object ClientSubscriptionSimulation extends Simulation {
  override def apply(f: (RequestHeader) => Future[Result], rh: RequestHeader, method: String)(implicit ec: ExecutionContext): Future[Result] = {
    Future.successful(Status(ErrorClientNotSubscribedToMTDVAT.httpStatusCode)(Json.toJson(ErrorClientNotSubscribedToMTDVAT)))
  }
}
